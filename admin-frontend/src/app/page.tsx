  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-300/10 to-indigo-300/10 dark:from-blue-300/5 dark:to-indigo-300/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="text-center space-y-12 p-8 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent leading-tight">
              FAQ Chatbot
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-5xl mx-auto">
              <div className="group bg-card/80 dark:bg-card/60 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-border/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="font-bold text-xl mb-3 text-foreground">FAQ Management</h3>
                <p className="text-muted-foreground leading-relaxed">Add, edit, and organize frequently asked questions with an intuitive interface</p>
              </div>
              ...
              <div className="group bg-card/80 dark:bg-card/60 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-border/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="font-bold text-xl mb-3 text-foreground">Analytics Dashboard</h3>
                <p className="text-muted-foreground leading-relaxed">Track usage metrics and user interactions with detailed analytics and insights</p>
              </div>
              ...
              <div className="group bg-card/80 dark:bg-card/60 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-border/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="font-bold text-xl mb-3 text-foreground">Real-time Monitoring</h3>
                <p className="text-muted-foreground leading-relaxed">Monitor system health and chat logs with real-time updates and notifications</p>
              </div>
            </div>
          </div>
