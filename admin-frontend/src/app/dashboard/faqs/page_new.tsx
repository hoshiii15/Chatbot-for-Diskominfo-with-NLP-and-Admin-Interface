                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <span className="px-3 py-1 bg-purple-100 text-purple-800 border border-purple-200 rounded-full text-xs font-medium flex items-center gap-1">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select 
                    ...
                    onChange={(e) => setFormState({...formState, environment: e.target.value as any})} 
